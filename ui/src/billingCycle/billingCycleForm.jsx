...
class BillingCycleForm extends Component {
    ...
    render(){
        ...
        const { sumOfCredits, sumOfDebts } = this.calculatSummary()
        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body'>
                    ...
                    <ItemList cols='12 6' list={debts} readOnly={readOnly} field='debts' legend='Débitos' showStats={true}/>
                </div>
...
const selecton = formValueSelector('billingCycleForm')
const mapStateToProps = state => ({
    credits: selecton(state, 'credits'), 
