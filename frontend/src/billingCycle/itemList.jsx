            ...
            <tr key={index}>
                ...
                <td>
                    <button type='button' className='btn btn-sucess'>
                        <i className='fa fa-plus' onClick={() => this.add(index + 1)}></i>
                    </button>
                    <button type='button' className='btn btn-warning'>
                        <i className='fa fa-clone' onClick={() => this.add(index + 1, item )}></i>
                    </button>
                    <button type='button' className='btn btn-danger'>
                        <i className='fa fa-trash-o' onClick={() => this.remove(index)}></i>
                    </button>
                </td>
            </tr>
        ))
